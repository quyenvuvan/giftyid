        ...
        <div className="container mx-auto px-4 py-10 md:py-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-3xl md:text-5xl font-bold text-white mb-6 leading-tight">
             Bứt Phá Doanh Thu <span className="text-yellow-300">Cùng GiftyID</span>
            </h1>
            <p className="text-xl text-blue-100 mb-8 leading-relaxed text-left">
            GiftyID mang đến cơ hội tuyệt vời để đối tác mở rộng kinh doanh và tiếp cận khách hàng một cách dễ dàng trên nền tảng Zalo quen thuộc.
            </p>
            <button 
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden mb-12 transform hover:scale-[1.01] transition-all duration-300">
            <div className="p-8">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Lợi Ích Vượt Trội Cho Đối Tác</h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-blue-50 dark:bg-blue-900/30 p-5 rounded-xl">
                  <div className="flex items-start">
                    ...
                    <p className="ml-4 text-gray-700 dark:text-gray-300 font-medium">
                      Tiếp cận tệp khách hàng lớn trên Zalo tại Hải Dương.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/30 p-5 rounded-xl">
                  <div className="flex items-start">
                    ...
                    <p className="ml-4 text-gray-700 dark:text-gray-300 font-medium">
                      Gia tăng nhận diện thương hiệu địa phương.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/30 p-5 rounded-xl">
                  <div className="flex items-start">
                    ...
                    <p className="ml-4 text-gray-700 dark:text-gray-300 font-medium">
                      Tận dụng mạng lưới Cộng tác viên Bưu điện Văn hóa Xã (CTV VHX) để quảng bá sản phẩm sâu rộng.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/30 p-5 rounded-xl">
                  <div className="flex items-start">
                    ...
                    <p className="ml-4 text-gray-700 dark:text-gray-300 font-medium">
                      Chi phí ban đầu tối ưu, không tốn kém xây dựng app/web riêng.
                    </p>
                  </div>
                </div>
                ...
                <div className="md:col-span-2 bg-blue-50 dark:bg-blue-900/30 p-5 rounded-xl">
                  <div className="flex items-start">
                    ...
                    <p className="ml-4 text-gray-700 dark:text-gray-300 font-medium">
                      Được Gifty Tech hỗ trợ tạo gian hàng, đăng sản phẩm ban đầu, marketing chung và hỗ trợ kỹ thuật.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden mb-12">
            <div className="bg-gradient-to-r from-blue-600 to-blue-500 text-white p-6">
              <div className="flex items-center">
                ...
                <h2 className="text-2xl font-bold">CHÍNH SÁCH & ĐIỀU KHOẢN ƯU ĐÃI</h2>
              </div>
            </div>
            ...
            <div className="p-8">
              ...
              <div className="mb-8">
                <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-white flex items-center">
                  ...
                  Vận Chuyển Tin Cậy (Nội tỉnh Hải Dương)
                </h3>
                <div className="bg-gray-50 dark:bg-gray-700/50 p-5 rounded-xl">
              ...
              <div className="mb-2">
                <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-white flex items-center">
                  ...
                  Đối Soát & Thanh Toán Nhanh Chóng
                </h3>
                <div className="bg-gray-50 dark:bg-gray-700/50 p-5 rounded-xl">
                  <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed">
